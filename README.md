...
从源码编译（为开发者）
bash
git clone [https://github.com/yourusername/TrajectoryCalculator.git](https://github.com/ZEROWHY233/IronBallisticCalc)](https://github.com/ZEROWHY233/TrajectoryCalculator.git)
